...
describe('CorehrService', () => {
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      providers: [CorehrService, provideHttpClient(), provideHttpClientTesting()],
    });
  ...
  describe('devices', () => {
    it('should list devices', () => {
      ...
      const req = httpMock.expectOne(r => r.url === `${API}/corehr/devices`);
    ...
    it('should create device', () => {
      ...
      const req = httpMock.expectOne(`${API}/corehr/devices`);
    ...
    it('should get device', () => {
      ...
      const req = httpMock.expectOne(`${API}/corehr/devices/1`);
      req.flush({ id: 1 });
    });
  ...
  describe('biometria', () => {
    it('should list biometria', () => {
      ...
      const req = httpMock.expectOne(r => r.url === `${API}/corehr/biometria`);
    ...
    it('should init enroll', () => {
      ...
      const req = httpMock.expectOne(`${API}/corehr/biometria/enroll/iniciar`);
      expect(req.request.method).toBe('POST');
  ...
  describe('attendance', () => {
    it('should list attendance', () => {
      ...
      const req = httpMock.expectOne(r => r.url === `${API}/corehr/attendance`);
    ...
    it('should get attendance by id', () => {
      ...
      const req = httpMock.expectOne(`${API}/corehr/attendance/att-123`);
  ...
  describe('non-working days', () => {
    it('should list non-working days', () => {
      ...
      const req = httpMock.expectOne(r => r.url === `${API}/corehr/non-working-days`);
    ...
    it('should create non-working day', () => {
      ...
      const req = httpMock.expectOne(`${API}/corehr/non-working-days`);
      expect(req.request.method).toBe('POST');
      req.flush({ id: 1 });
    });
    ...
    it('should patch non-working day', () => {
      ...
      const req = httpMock.expectOne(`${API}/corehr/non-working-days/1`);
      expect(req.request.method).toBe('PATCH');
      req.flush({ id: 1 });
    });
  ...
  describe('tenant contacts', () => {
    it('should list contacts', () => {
      ...
      const req = httpMock.expectOne(r => r.url === `${API}/corehr/tenant-contacts`);
    ...
    it('should create contact', () => {
      ...
      const req = httpMock.expectOne(`${API}/corehr/tenant-contacts`);
      expect(req.request.method).toBe('POST');
      req.flush({ id: 1 });
    });
    ...
    it('should delete contact', () => {
      ...
      const req = httpMock.expectOne(`${API}/corehr/tenant-contacts/1`);
      expect(req.request.method).toBe('DELETE');
      req.flush(null);
    });
  });
  ...
  describe('user departments', () => {
    it('should list departments', () => {
      ...
      const req = httpMock.expectOne(`${API}/corehr/usuarios/5/departamentos`);
    ...
    it('should patch department', () => {
      ...
      const req = httpMock.expectOne(`${API}/corehr/usuarios/5/departamentos/3`);
      expect(req.request.method).toBe('PATCH');
      req.flush({ id: 3 });
    });
  });
  ...
  describe('asistencia middleware', () => {
    it('should marcar', () => {
      ...
      const req = httpMock.expectOne(`${API}/asistencia/marcar`);
      expect(req.request.method).toBe('POST');
      expect(req.request.body).toEqual(body);
      req.flush({ id: 'att-1' });
    });
    ...
    it('should sync attendance', () => {
      ...
      const req = httpMock.expectOne(`${API}/asistencia/sync`);
      expect(req.request.method).toBe('POST');
      expect(req.request.body).toEqual(body);
