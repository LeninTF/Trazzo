...
describe('HorariosService', () => {
  ...
  describe('shifts', () => {
    it('should list shifts', () => {
      ...
      const req = httpMock.expectOne(r => r.url === `${apiBase}/corehr/shifts`);
    ...
    it('should create shift', () => {
      ...
      const req = httpMock.expectOne(`${apiBase}/corehr/shifts`);
    ...
    it('should get shift', () => {
      ...
      const req = httpMock.expectOne(`${apiBase}/corehr/shifts/1`);
      expect(req.request.method).toBe('GET');
      req.flush({ id: 1 });
    });
  ...
  describe('schedules', () => {
    it('should list schedules', () => {
      ...
      const req = httpMock.expectOne(r => r.url === `${apiBase}/corehr/schedules`);
    ...
    it('should create schedule', () => {
      ...
      const req = httpMock.expectOne(`${apiBase}/corehr/schedules`);
      expect(req.request.method).toBe('POST');
      req.flush({ id: 1 });
    });
  ...
  describe('tolerancias', () => {
    it('should list tolerancias', () => {
      ...
      const req = httpMock.expectOne(`${apiBase}/corehr/schedules/1/tolerancias`);
      expect(req.request.method).toBe('GET');
      req.flush({ data: [], meta: { total: 0 } });
    });
    ...
    it('should patch tolerancia', () => {
      ...
      const req = httpMock.expectOne(`${apiBase}/corehr/schedules/1/tolerancias/2`);
      expect(req.request.method).toBe('PATCH');
      req.flush({ id: 2 });
    });
  ...
  describe('user schedules', () => {
    it('should list user schedules', () => {
      ...
      const req = httpMock.expectOne(r => r.url === `${apiBase}/corehr/user-schedules`);
    ...
    it('should create user schedule', () => {
      ...
      const req = httpMock.expectOne(`${apiBase}/corehr/user-schedules`);
      expect(req.request.method).toBe('POST');
      expect(req.request.body).toEqual(body);
      req.flush({ id: 1 });
    });
    ...
    it('should delete user schedule', () => {
      ...
      const req = httpMock.expectOne(`${apiBase}/corehr/user-schedules/1`);
      expect(req.request.method).toBe('DELETE');
      req.flush(null);
    });
  });
