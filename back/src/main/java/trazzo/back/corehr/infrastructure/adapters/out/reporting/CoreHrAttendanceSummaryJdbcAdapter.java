...
public class CoreHrAttendanceSummaryJdbcAdapter implements CoreHrAttendanceSummaryPort {
    ...
    public CoreHrAttendanceSummaryJdbcAdapter(JdbcTemplate jdbcTemplate) {
