...
class CreateMonthlyClosureRequestTest {
    ...
    void shouldCreateRequestSuccessfully() {
        ...
        assertEquals("user-1", request.createdByUserId());
    }

    @Test
    void shouldBeEqualForSameValues() {
        CreateMonthlyClosureRequest r1 = new CreateMonthlyClosureRequest(6, 2025, "user-1");
        CreateMonthlyClosureRequest r2 = new CreateMonthlyClosureRequest(6, 2025, "user-1");
        assertEquals(r1, r2);
    ...
    void shouldNotBeEqualForDifferentValues() {
        CreateMonthlyClosureRequest r1 = new CreateMonthlyClosureRequest(6, 2025, "user-1");
        CreateMonthlyClosureRequest r2 = new CreateMonthlyClosureRequest(7, 2025, "user-2");
