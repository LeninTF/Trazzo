...
class AuditLogDetailResultTest {
    ...
    void shouldTestEquality() {
        var now = LocalDateTime.now();
        var r1 = new AuditLogDetailResult("1", "E", "1", "DELETE", "u", "/e", "ip", "ua", null, null, now);
        var r2 = new AuditLogDetailResult("1", "E", "1", "DELETE", "u", "/e", "ip", "ua", null, null, now);
        assertEquals(r1, r2);
    ...
    void shouldTestToString() {
        var result = new AuditLogDetailResult(null, "User", null, "CREATE", null, null, null, null, null, null, null);
