...
class NotificationServiceTest {
    ...
    void notifyWithExistingIncident() {
        var incident = Incident.restore(1, 1, 1,
        ...
        assertDoesNotThrow(() -> service.notify(1, command));
    }
    ...
    void notifyWithNonExistentIncidentThrowsException() {
        ...
        assertThrows(IllegalArgumentException.class,
                () -> service.notify(999, new NotifyIncidentCommand("JUSTIFICACION")));
    }
    ...
    void justifyAttendanceWithExistingIncident() {
        ...
        assertDoesNotThrow(() -> service.justifyAttendance(1));
    }
